...
const packagingGroups: {label: string; specs: [string, string][]}[] = [
  {
    ...
    specs: [
      ...
      [
        'images/private-label/stand-up-pouches-gusset.png',
        'Side and Bottom Gusset Stand up Pouches (SUPs)',
      ],
...
export async function seedPrivateLabelPage(): Promise<void> {
  ...
  const [
    ...
    Promise.all([
      uploadImage(
        'images/private-label/certified-organic-warehouse.jpg',
        'Switch Supply private label warehouse',
      ),
    ...
    Promise.all([
      uploadImage(
        'images/private-label/sustainable-packaging-options.png',
        'Sustainable packaging options',
      ),
      uploadImage(
        'images/private-label/functional-nutrition-demand.png',
        'Functional nutrition demand',
      ),
  ...
  const doc = {
    ...
    hero: {
      ...
      cta: staticCta('Start Your Brand', '/contact'),
      bullets: [
        '500+ Ingredients',
    ...
    globalIngredients: {
      ...
      images: [
        ...(globalImg0
          ? [{_key: 'gi-0', ...img(globalImg0), label: 'Your Label Here', wide: false}]
          : []),
        ...(globalImg1
          ? [{_key: 'gi-1', ...img(globalImg1), label: 'Your Label Here', wide: false}]
          : []),
        ...(globalImg2
          ? [{_key: 'gi-2', ...img(globalImg2), label: 'Your Brand', wide: true}]
          : []),
      ],
    },
      ...
      products: [
        {
          ...
          ...img(prod0),
          title: 'Adaptogens',
          description: 'Stress support and mood balance with clean-label positioning.',
          badges: ['Ashwagandha', 'Rhodiola Rosea', 'Saffron'],
        },
        {
          _key: 'tp-1',
          ...img(prod1),
          title: 'Functional Extracts',
          description: 'High-performing extracts for sports and daily wellness.',
          badges: ['Electrolyte/Hydration Powder', 'Moringa', 'Matcha', 'Creatine'],
        },
        {
          _key: 'tp-2',
          ...img(prod2),
          title: 'Fibres & Pre/Postbiotics',
          description:
            'Expand your gut portfolio with versatile fibres and heat-stabilised postbiotics.',
          badges: ['L. Glutamine', 'Collagen Peptides', 'Bone Broth Powder', 'Green Banana Powder'],
        },
        {
          _key: 'tp-3',
          ...img(prod3),
          title: 'Mushroom Powders',
          description: 'Hero mushrooms for modern wellness and beverage formats.',
          badges: ['Reishi', 'Chaga', 'Cordyceps Extract'],
        },
        {
          _key: 'tp-4',
          ...img(prod4),
          title: 'Nootropics',
          description: 'Three proven heroes for clean focus, memory and mental energy.',
          badges: ["Lion's Mane", 'L. Theanine', 'Black Maca'],
        },
      ],
    },
      ...
      cards: [
        {
          ...
          ...img(npd0),
          title:
            'Full Turn Key Solution - Packed at Origin from multiple producers located across Asia and Europe',
          description: 'Use our proven formulas and packaging, and launch your brand efficiently.',
          cta: staticCta('Start with Private Label', '/contact'),
        },
        {
          _key: 'npd-1',
          ...img(npd1),
          ...
          description:
            'Have a unique idea? Work with our experts to develop and launch a custom-made product.',
          cta: staticCta('Create a New Product', '/contact'),
        },
      ],
    },
    ...
    packagingFormats: {
      ...
      subheading: 'Premium, functional, and customisable packaging to elevate your brand presence.',
    ...
    midCta: {
      ...
      cta: staticCta('Speak with an Expert', '/contact'),
    },
    ...
    trending: {
      ...
      featuredPost: {
        ...
        cta: staticCta('Read Full Article', '/blog/functional-nutrition-demand'),
      },
      posts: [
        {
          _key: 'post-0',
          ...
          cta: staticCta('Read More', '/blog/supply-chain-volatility'),
        },
        {
          _key: 'post-1',
          ...
          cta: staticCta('Read More', '/blog/clean-label-reformulation'),
        },
        {
          _key: 'post-2',
          ...
          cta: staticCta('Read More', '/blog/sustainability-traceability'),
        },
      ],
    },
    ...
    finalCta: {
      ...
      subheading: 'Custom recipe and formula with our food scientists and NPD experts.',
      cta: staticCta('Start My Private Label', '/contact'),
